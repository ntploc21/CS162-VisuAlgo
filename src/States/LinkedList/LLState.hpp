...
namespace State {
    /**
     * @brief The state class that is used as a base linked list
    ...
    public:
        /**
         * @brief Construct a new LLState object
         * @param stack The state stack where the linked list state is pushed
         * to.
         * @param context The context of the application.
         * @param activeDS The active data structure.
         */
        LLState(StateStack& stack, Context context,
                DataStructures::ID activeDS);

        /**
         * @brief Destroy the LLState object
         */
        ~LLState();

        /**
         * @brief Draw the linked list state to the screen.
         */
        virtual void Draw();

        /**
         * @brief Update the linked list state.
         * @param dt The delta time between two frames.
